...
public class InfoCiclo implements ActionListener{
	...
	private static JFormattedTextField dataField;
	...
	public InfoCiclo(ControlerDados dados, int i, String data, boolean mens, int durCiclo, int durMens, Intensidade intensidade){
		this.data = data;
		this.mens = mens;
	...
	public InfoCiclo(ControlerDados dados) {
		this.data = data;
		this.mens = mens;
		this.durCiclo = durCiclo;
		this.durMens = durMens;
